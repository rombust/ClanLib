...
namespace clan
{
	...
	{
	public:
		explicit VulkanWindowProvider_X11(std::shared_ptr<VulkanDevice> device, VulkanContextDescription &vk_desc);
		~VulkanWindowProvider_X11() override;

		Rect get_geometry() const override
		{
			return x11_window.get_geometry();
		}
		Rect get_viewport() const override
		{
			return x11_window.get_viewport();
		}
		float get_pixel_ratio() const override
		{
			return x11_window.get_pixel_ratio();
		}

		bool has_focus() const override
		{
			return x11_window.has_focus();
		}
		bool is_fullscreen() const override
		{
			return x11_window.is_fullscreen();
		}
		bool is_minimized() const override
		{
			return x11_window.is_minimized();
		}
		bool is_maximized() const override
		{
			return x11_window.is_maximized();
		}
		bool is_visible() const override
		{
			return x11_window.is_visible();
		}
		bool is_clipboard_text_available() const override
		{
			return x11_window.is_clipboard_text_available();
		}
		bool is_clipboard_image_available() const override
		{
			return x11_window.is_clipboard_image_available();
		}

		std::string get_title() const override
		{
			return x11_window.get_title();
		}
		Size get_minimum_size(bool ca) const override
		{
			return x11_window.get_minimum_size(ca);
		}
		Size get_maximum_size(bool ca) const override
		{
			return x11_window.get_maximum_size(ca);
		}

		std::string get_clipboard_text() const override
		{
			return x11_window.get_clipboard_text();
		}
		PixelBuffer get_clipboard_image() const override
		{
			return x11_window.get_clipboard_image();
		}
		DisplayWindowHandle get_handle() const override
		{
			return x11_window.get_handle();
		}
		...
		{
			return x11_window.get_keyboard();
		}
		InputDevice &get_mouse() override
		{
			return x11_window.get_mouse();
		}
		std::vector<InputDevice> &get_game_controllers() override
		{
			return x11_window.get_game_controllers();
		}
		...
		Point client_to_screen(const Point &p) override
		{
			return x11_window.client_to_screen(p);
		}
		Point screen_to_client(const Point &p) override
		{
			return x11_window.screen_to_client(p);
		}

		void show_system_cursor() override
		{
			x11_window.show_system_cursor();
		}
		void hide_system_cursor() override
		{
			x11_window.hide_system_cursor();
		}
		...
		{
			x11_window.set_cursor(type);
		}

		void set_title(const std::string &t) override
		{
			x11_window.set_title(t);
		}
		void set_position(const Rect &pos, bool ca) override
		{
			x11_window.set_position(pos, ca);
		}
		void set_size(int w, int h, bool ca) override
		{
			x11_window.set_size(w, h, ca);
		}
		void set_minimum_size(int w, int h, bool ca) override
		{
			x11_window.set_minimum_size(w, h, ca);
		}
		void set_maximum_size(int w, int h, bool ca) override
		{
			x11_window.set_maximum_size(w, h, ca);
		}
		void set_pixel_ratio(float r) override
		{
			x11_window.set_pixel_ratio(r);
		}
		void set_enabled(bool enable) override
		{
			x11_window.set_enabled(enable);
		}
		...
		{
			x11_window.toggle_fullscreen();
		}
		void show(bool activate) override
		{
			x11_window.show(activate);
		}
		void hide() override
		{
			x11_window.hide();
		...
		{
			x11_window.request_repaint();
		}

		void set_clipboard_text(const std::string &t) override
		{
			x11_window.set_clipboard_text(t);
		}
		void set_clipboard_image(const PixelBuffer &b) override
		{
			x11_window.set_clipboard_image(b);
		}
		...
		{
			return static_cast<uint32_t>(current_frame);
		}
