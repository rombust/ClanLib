...
namespace clan
{
	...
	bool VulkanWindowProvider::is_clipboard_text_available() const
	{
		return win32_window.is_clipboard_text_available();
	}
	bool VulkanWindowProvider::is_clipboard_image_available() const
	{
		return win32_window.is_clipboard_image_available();
	}
	std::string VulkanWindowProvider::get_clipboard_text() const
	{
		return win32_window.get_clipboard_text();
	}
	PixelBuffer VulkanWindowProvider::get_clipboard_image() const
	{
	...
	void VulkanWindowProvider::set_cursor(StandardCursor t)
	{
		win32_window.set_cursor(t);
	}
	void VulkanWindowProvider::set_cursor_handle(HCURSOR c)
	{
		win32_window.set_cursor_handle(c);
	}
	...
	void VulkanWindowProvider::set_clipboard_text(const std::string &t)
	{
		win32_window.set_clipboard_text(t);
	}
	void VulkanWindowProvider::set_clipboard_image(const PixelBuffer &b)
	{
		win32_window.set_clipboard_image(b);
	}
