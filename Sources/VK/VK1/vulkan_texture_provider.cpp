...
namespace clan
{
		...
		int min_level, int num_levels, int min_layer, int num_layers)
	{
		...
		switch (dims)
		{
		case TextureDimensions::_1d: vtype = VK_IMAGE_VIEW_TYPE_1D; break;
		case TextureDimensions::_1d_array: vtype = VK_IMAGE_VIEW_TYPE_1D_ARRAY; break;
		case TextureDimensions::_2d: vtype = VK_IMAGE_VIEW_TYPE_2D; break;
		case TextureDimensions::_2d_array: vtype = VK_IMAGE_VIEW_TYPE_2D_ARRAY; break;
		case TextureDimensions::_3d: vtype = VK_IMAGE_VIEW_TYPE_3D; break;
		case TextureDimensions::_cube: vtype = VK_IMAGE_VIEW_TYPE_CUBE; break;
