...
#pragma managed(pop)
	...
	#if !defined(_DEBUG)
		#if defined(DLL)
			#pragma comment(lib, "clanVK-dll.lib")
		#elif defined(_DLL)
			#pragma comment(lib, "clanVK-static-mtdll.lib")
		#else
			#pragma comment(lib, "clanVK-static-mt.lib")
		#endif
	#else
		#if defined(DLL)
			#pragma comment(lib, "clanVK-dll-debug.lib")
		#elif defined(_DLL)
			#pragma comment(lib, "clanVK-static-mtdll-debug.lib")
		#else
			#pragma comment(lib, "clanVK-static-mt-debug.lib")
		#endif
	#endif
#endif
